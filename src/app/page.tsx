      ...
      <section className="bg-brand-white border-b sm:border-b-0 border-brand-border pt-8 sm:pt-14 pb-8 sm:pb-16 px-4 sm:px-6 lg:px-8">
        <div className="max-w-7xl mx-auto">
          <div className="max-w-3xl mb-8 sm:mb-12">
            <div className="inline-flex items-center space-x-2 bg-brand-red-subtle border border-red-200 px-3 py-1 rounded-full text-[11px] font-bold uppercase tracking-wider text-brand-red mb-4">
          ...
          <div className="grid grid-cols-2 sm:grid-cols-4 gap-3 sm:gap-4 mb-8 sm:mb-12">
            <Link
              href="/book"
              className="bg-brand-red text-brand-white p-4 sm:p-5 rounded-xl hover:bg-brand-red-hover transition flex flex-col justify-between group shadow-md shadow-red-900/15"
            >
            ...
            {!isChatOpen ? (
              <div className="bg-brand-subtle border border-brand-border rounded-2xl p-4 sm:p-5 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 shadow-sm">
                <div className="flex items-center space-x-3.5">
                  <div className="w-10 h-10 rounded-full bg-brand-red-subtle text-brand-red flex items-center justify-center shrink-0 border border-red-200 shadow-sm">
      ...
      <section className="py-10 sm:py-16 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto w-full">
        ...
        <div className="flex md:grid md:grid-cols-3 overflow-x-auto md:overflow-visible gap-4 md:gap-6 snap-x snap-mandatory scrollbar-none pb-4 -mx-4 px-4 md:mx-0 md:px-0">
          {MOCK_OFFERS.slice(0, 3).map((offer) => (
            <div
              key={offer.id}
              className="w-[85vw] sm:w-[320px] md:w-auto shrink-0 snap-center bg-brand-white border border-brand-border rounded-xl p-5 flex flex-col justify-between hover:border-brand-black hover:shadow-md transition-all group"
            >
              <div>
              ...
              <div className="mt-6 pt-4 border-t border-brand-border flex items-center justify-between">
                ...
                <button
                  ...
                  className="bg-brand-red text-brand-white text-xs font-bold uppercase tracking-wider px-4 py-2.5 rounded-lg hover:bg-brand-red-hover transition shadow-md shadow-red-900/15 min-h-[44px]"
                >
                  Book Combo
                </button>
              </div>
